            ...
            for point in extremum_points:
                ...
                try:
                    ...
                    if 0 <= idx < len(data_slice):
                        fixed_extremums.append((idx, price, is_high))
        ...
        if True:  # Check every single bar
            try:
                ...
                if len(extremum_points) >= 4:
                    ...
                    all_abcd, all_xabcd = detect_all_gui_patterns(extremum_points, data_slice_with_date, max_patterns=200)
                else:
                    all_abcd, all_xabcd = [], []
