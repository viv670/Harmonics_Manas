...
def detect_all_gui_patterns(extremums: List[Tuple],
                          ...
                          log_details: bool = False,
                          max_patterns: int = None,
                          validate_d_crossing: bool = True) -> Tuple[List[Dict], List[Dict]]:
    """
    ...
    abcd_patterns = detect_gui_compatible_abcd_patterns(
        extremums, df, log_details, max_patterns, validate_d_crossing
    )

    xabcd_patterns = detect_gui_compatible_xabcd_patterns(
        extremums, df, log_details, max_patterns, None, validate_d_crossing
    )
